...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/ws-esi.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/ws-esi)
...
```php
$eSI = new NicolasKion\ESI();
echo $eSI->echoPhrase('Hello, NicolasKion!');
```
